...
{
    Task<(ICollection<SessionTableItemDTO>, int TotalCount)> SessionsAsTableItemAsync(string? q = null, DateTime? startDate = null, DateTime? endDate = null, SessionStatus? status = null, int page = 0, int count = 25);
